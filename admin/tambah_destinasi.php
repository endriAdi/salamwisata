...
<body>
	...
	<?php 
		if (isset($_POST['save']))
		{
			...
			$koneksi->query("INSERT INTO destinasi
				(nama_destinasi,foto_destinasi,keterangan) 
				VALUES ('$_POST[nama_destinasi]','$nama[0]','$_POST[keterangan]')");
			...
			$koneksi->query("INSERT INTO destinasi_foto (id_destinasi,nama_destinasi_foto)  
